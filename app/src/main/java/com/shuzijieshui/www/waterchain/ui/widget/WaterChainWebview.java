package com.shuzijieshui.www.waterchain.ui.widget;
...
public class WaterChainWebview extends WebView {
    public WaterChainWebview(Context context) {
        super(context);
        webViewSetting();
    }

    public WaterChainWebview(Context context, AttributeSet attrs) {
        super(context, attrs);
        webViewSetting();
    }

    public WaterChainWebview(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        webViewSetting();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public WaterChainWebview(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        webViewSetting();
    }

    public WaterChainWebview(Context context, AttributeSet attrs, int defStyleAttr, boolean privateBrowsing) {
